...
static void activate(GtkApplication* app, gpointer data) {
    ...
    //GValue darkmode = G_VALUE_INIT;
    //va_list lst;
    //g_object_get_valist(G_OBJECT(gtk_settings_get_default()), "gtk-application-prefer-dark-theme", &lst);
    //g_object_get_property(G_OBJECT(gtk_settings_get_default()), "gtk-application-prefer-dark-theme", &darkmode);
    //printf("%d\n", g_value_get_boolean(&darkmode));
